...
@ANIO VARCHAR(10)
AS
INSERT INTO AUTOBUS(MARCA,MODELO,PLACA,COLOR,ANIO) VALUES (@MARCA,@MODELO,@PLACA,@COLOR,@ANIO)
...
@ANIO VARCHAR(10)
AS
UPDATE AUTOBUS SET MARCA=@MARCA, MODELO=@MODELO, PLACA=@PLACA, COLOR=@COLOR, ANIO=@ANIO
...
-----------------------------------------------------------------------
CREATE PROC SP_DISPONIBLE_CHOFER_V
@NOMBRE VARCHAR(30)
AS
UPDATE CHOFER SET DISPON='V' WHERE NOMBRE=@NOMBRE

CREATE PROC SP_DISPONIBLE_AUTOBUS_V
@MODELO VARCHAR(30)
AS
UPDATE AUTOBUS SET DISPON='V' WHERE MODELO=@MODELO

CREATE PROC SP_DISPONIBLE_RUTA_V
@NOMBRE VARCHAR(30)
AS
